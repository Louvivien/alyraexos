class Noeud {
    ...
    trouver(valeur) {
        if (this.valeur == valeur)   //critere darret recursif
            return this;
    ...
    ajouter(valeur) {
        if (valeur < this.valeur) {
            if (this.gauche === undefined) {
                ...
                this.gauche.ajouter(valeur);  //on descend au niveau en dessous
            }
        } else {
            if (this.droite === undefined) {
                ...
                this.droite.ajouter(valeur); //on descend au niveau en dessous
            }
        }
    }
    ...
    //noeud depart entre la visite de l’arbre de gauche et 
    //la visite de l'arbre de droite (parcours infixe)
    infixe() {
        let values = [];
        if (this.gauche !== undefined)
...
arbre = new Arbre()
noeud = new Noeud()
arbre.ajouterNoeud(4)
arbre.ajouterNoeud(2)
arbre.ajouterNoeud(5)
arbre.ajouterNoeud(6)

console.log(arbre.infixe())
arbre.printNoeud(5)

arbre.supprimerNoeud(5)
